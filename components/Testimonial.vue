<template>
    <div class="bg-white dark:bg-dark-800 rounded-2xl shadow-sm p-8">
        <div class="flex gap-2 items-center font-medium">
            <img :src="rate?.author?.avatar" class="w-8 h-8 rounded-full mr-2" alt="Avatar" />
            {{ rate?.author?.username }}
            <span>-</span>
