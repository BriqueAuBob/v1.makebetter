<template>
  <div
    ...
    :style="`border-color: ${data.color}; max-width: ${
      data.image.url ? '432' : '516'
    }px;`"
  >
    <ClientOnly>
      <div
      ...
      >
        <div class="mr-2 py-2">
          <div
            v-if="data.author?.icon_url || data.author?.name"
            class="mb-2 flex items-center text-sm font-semibold"
          >
            <img
              v-if="data.author.icon_url"
          ...
          <a
            ...
            :class="data.author.url && 'title hover:underline'"
          >
            {{ data.title }}
          </a>
      ...
      <footer
        v-if="data.timestamp || data.footer?.text || data.footer?.icon_url"
        class="mt-2 flex items-center"
      >
        <img
          v-if="data.footer?.icon_url"
