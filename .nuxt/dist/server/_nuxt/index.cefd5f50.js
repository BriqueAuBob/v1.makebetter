import { _ as _export_sfc, u as useAuthStore, a as axios2, v as vue_cjs_prod, b as __nuxt_component_4, c as __nuxt_component_1, d as __nuxt_component_0 } from "../server.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><header class="pt-48 pb-32 bg-dark-900 flex flex-col items-center justify-center relative overflow-y-hidden"><div class="absolute top-0 left-0 w-full h-full bg-dark-950 opacity-75 blur-xl bg-cover bg-center z-0" style="${ssrRenderStyle(`background-image: url(${(_a = _ctx.user) == null ? void 0 : _a.avatar});`)}"></div><img class="rounded-full w-48 z-10 border-8 border-white"${ssrRenderAttr("src", (_b = _ctx.user) == null ? void 0 : _b.avatar)}><div class="font-semibold text-2xl mt-4 text-center mx-auto z-10 text-white">${ssrInterpolate((_c = _ctx.user) == null ? void 0 : _c.username)}</div><div class="font-medium text-xl mt-1 text-gray-400 text-center mx-auto z-10">#${ssrInterpolate((_d = _ctx.user) == null ? void 0 : _d.discriminator)}</div></header><section class="container mx-auto py-32 px-4 lg:px-16 xl:px-32"><div class="font-semibold text-lg mb-2">Mes informations</div><p class="text-gray-500 mb-4">Ici, vous pouvez voir toutes les informations que nous sauvegardons \xE0 propos de votre profil.</p><div class="grid md:grid-cols-2 gap-4 italic"><div><span class="ml-2">ID</span>`);
