...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Slider, {
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div${_scopeId}><!--[-->`);
        ssrRenderList(_ctx.colors.sort((a, b) => 0.5 - Math.random()), (color, index) => {
            ...
            _push2(ssrRenderComponent(_component_Card, null, {
              default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div><span class="flex items-center gap-2 font-medium text-primary-500 mt-4"${_scopeId2}>Postuler <img${ssrRenderAttr("src", _imports_0)} class="w-5 h-5" alt="Double chevron"${_scopeId2}></span></div>`);
                } else {
                  return [
