...
const Navbar_vue_vue_type_style_index_0_scoped_017435d9_lang = "";
const _sfc_main = {
  components: {
    MoonIcon,
    SunIcon
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<nav${ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "absolute top-0 w-full z-10" }, _attrs))} data-v-017435d9><div class="container mx-auto flex items-center justify-between py-6 text-white px-4" data-v-017435d9><div class="flex basis-0 grow" data-v-017435d9>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img class="h-10"${ssrRenderAttr("src", _imports_0)} data-v-017435d9${_scopeId}> umaestro.fr `);
      } else {
        return [
  ...
  ssrRenderList(_ctx.navigation, (link, index) => {
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<li class="ease-in duration-300 hover:text-white" data-v-017435d9${_scopeId}>${ssrInterpolate(link.name)}</li>`);
        } else {
          return [
  ...
  _push(`<!--]--></ul><div class="gap-6 items-center hidden lg:flex basis-0 grow justify-end" data-v-017435d9><span class="cursor-pointer"${ssrRenderAttr("small", true)} data-v-017435d9>`);
  ...
  if (!_ctx.authenticated) {
    ...
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        var _a, _b, _c, _d;
        if (_push2) {
          _push2(`<img${ssrRenderAttr("src", (_a = _ctx.user) == null ? void 0 : _a.avatar)} class="w-6 h-6 rounded-full" data-v-017435d9${_scopeId}> ${ssrInterpolate((_b = _ctx.user) == null ? void 0 : _b.username)}`);
        } else {
          return [
            vue_cjs_prod.createVNode("img", {
  ...
  _push(`</div><button class="lg:hidden px-4 py-2" data-v-017435d9><img${ssrRenderAttr("src", _imports_1)} class="w-8 h-8" data-v-017435d9></button><div class="${ssrRenderClass([!_ctx.menuOpen && "-z-1 opacity-0", "ease-in duration-300 absolute top-0 left-0 w-full h-screen p-8 flex flex-col"])}" data-v-017435d9><div class="flex justify-between" data-v-017435d9>`);
  if (!_ctx.authenticated) {
    _push(ssrRenderComponent(_component_NuxtLink, {
      to: "/authentification",
    ...
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        var _a, _b, _c, _d;
        if (_push2) {
          _push2(`<img${ssrRenderAttr("src", (_a = _ctx.user) == null ? void 0 : _a.avatar)} class="w-8 h-8 rounded-full" data-v-017435d9${_scopeId}> ${ssrInterpolate((_b = _ctx.user) == null ? void 0 : _b.username)}`);
        } else {
          return [
            vue_cjs_prod.createVNode("img", {
              src: (_c = _ctx.user) == null ? void 0 : _c.avatar,
  ...
  ssrRenderList(_ctx.navigation, (link, index) => {
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<li class="text-xl font-medium py-4 ease-in duration-300 hover:text-gray-900 dark:hover:text-dark-100" data-v-017435d9${_scopeId}>${ssrInterpolate(link.name)}</li>`);
        } else {
          return [
