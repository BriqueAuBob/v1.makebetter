import { _ as _export_sfc, a as axios2, v as vue_cjs_prod, s as __nuxt_component_0, d as __nuxt_component_0$1, c as __nuxt_component_1, A as __nuxt_component_3, b as __nuxt_component_4, C as __nuxt_component_5, D as __nuxt_component_6, F as __nuxt_component_7, G as __nuxt_component_8, j as __nuxt_component_9, y as __nuxt_component_10, H as __nuxt_component_11 } from "../server.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_Button, {
                ...
                icon_left: vue_cjs_prod.withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_CubeIcon, { class: "mr-3 w-8 h-8" }, null, _parent4, _scopeId3));
                  } else {
                    return [
    ...
    _push(ssrRenderComponent(_component_ToolsDiscordEmbedCreatorStep, {
      ...
      bin: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(ssrRenderComponent(_component_TrashIcon, { class: "w-6 h-6" }, null, _parent2, _scopeId));
          _push2(`</button>`);
        } else {
          return [
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ...
          _push2(ssrRenderComponent(_component_Menu, {
            ...
            default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(ssrRenderComponent(_component_MenuButton, { class: "bg-white dark:bg-dark-800 flex gap-6 items-center p-8 rounded-xl shadow-lg ease-in duration-200 hover:shadow-xl hover:-translate-y-1 dark:hover:bg-dark-700 cursor-pointer" }, {
                  default: vue_cjs_prod.withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(ssrRenderComponent(_component_UploadIcon, { class: "w-8 h-8" }, null, _parent4, _scopeId3));
                ...
                _push3(``);
                _push3(ssrRenderComponent(_component_MenuItems, { class: "absolute left-0 w-full mt-2 origin-top-right divide-y divide-gray-100 rounded-md bg-white dark:bg-dark-800 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10" }, {
                  default: vue_cjs_prod.withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
          ...
          _push2(ssrRenderComponent(_component_ToolsDiscordEmbedCreatorStep, {
            ...
            default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              if (_push3) {
                ...
                _push3(ssrRenderComponent(_component_UploadIcon, { class: "w-8 h-8" }, null, _parent3, _scopeId2));
                _push3(`<span class="ml-2"${_scopeId2}>${ssrInterpolate(((_a = message.files) == null ? void 0 : _a.length) > 0 ? `${message.files.length} fichiers attach\xE9s` : "Ajouter un fichier")}</span></div><input class="absolute opacity-0 w-full h-full top-0 left-0 cursor-pointer" type="file" multiple${_scopeId2}></div>`);
                if (message.files) {
                  ...
                  ssrRenderList(message.files, (file, index) => {
                    ...
                    _push3(ssrRenderComponent(_component_TrashIcon, { class: "w-12 h-12" }, null, _parent3, _scopeId2));
                    _push3(`</div></div></div>`);
                  });
                  _push3(`<!--]--></div>`);
                } else {
                                ...
                                default: vue_cjs_prod.withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    ssrRenderList(_ctx.defaultColors, (color, index) => {
                                      _push6(`<div class="w-7 h-7 rounded-md flex items-center justify-center cursor-pointer" style="${ssrRenderStyle(`background: ${color};`)}"${_scopeId5}>`);
                                      if (embed2.color == color) {
                                        _push6(ssrRenderComponent(_component_CheckIcon, { class: "w-6 h-6" }, null, _parent6, _scopeId5));
                                      } else {
                                        _push6(`<!---->`);
                                      }
                                      _push6(`</div>`);
            ...
            default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
              ...
              if (_push3) {
                ...
                if (!_ctx.is_application_webhook) {
                  _push3(`<div class="absolute w-full h-full top-0 bg-background dark:bg-dark-950 bg-opacity-95 dark:bg-opacity-95 flex justify-center items-center"${_scopeId2}><div class="text-md font-semibold"${_scopeId2}>Tu dois utiliser un webhook cr\xE9\xE9 par un bot pour ajouter des boutons.</div></div>`);
                } else {
                  _push3(`<!---->`);
                }
              } else {
                return [
                  ...
                  !_ctx.is_application_webhook ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", {
                    key: 0,
                    class: "absolute w-full h-full top-0 bg-background dark:bg-dark-950 bg-opacity-95 dark:bg-opacity-95 flex justify-center items-center"
                  }, [
                        ...
                        default: vue_cjs_prod.withCtx((_4, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
                            ...
                            _push5(ssrRenderComponent(_component_TransitionChild, {
                              ...
                              default: vue_cjs_prod.withCtx((_5, _push6, _parent6, _scopeId5) => {
                                if (_push6) {
                                  _push6(ssrRenderComponent(_component_DialogPanel, { class: "w-full max-w-2xl max-h-screen-padding transform overflow-hidden rounded-2xl bg-white dark:bg-dark-900 p-6 text-left align-middle shadow-xl transition-all" }, {
                                    default: vue_cjs_prod.withCtx((_6, _push7, _parent7, _scopeId6) => {
                                      if (_push7) {
                                        ...
                                        _push7(`<pre class="bg-dark-700 my-4 max-h-96 overflow-auto"${_scopeId6}><code${_scopeId6}>${ssrInterpolate(message)}</code></pre><div class="flex gap-2 items-center mt-4 justify-end"${_scopeId6}>`);
                        ...
                        default: vue_cjs_prod.withCtx((_4, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
                            ...
                            _push5(ssrRenderComponent(_component_TransitionChild, {
                              ...
                              default: vue_cjs_prod.withCtx((_5, _push6, _parent6, _scopeId5) => {
                                if (_push6) {
                                  _push6(ssrRenderComponent(_component_DialogPanel, { class: "w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-dark-900 p-6 text-left align-middle shadow-xl transition-all" }, {
                                    default: vue_cjs_prod.withCtx((_6, _push7, _parent7, _scopeId6) => {
                                      if (_push7) {
                                        _push7(ssrRenderComponent(_component_DialogTitle, {
                                          as: "h3",
  ...
  _push(ssrRenderComponent(_component_EyeIcon, { class: "w-12 h-12" }, null, _parent));
