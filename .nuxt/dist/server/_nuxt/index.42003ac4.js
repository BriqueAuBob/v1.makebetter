import { _ as _export_sfc, q as allCards, r as useModule, t as tools, v as vue_cjs_prod, s as __nuxt_component_0, d as __nuxt_component_1, h as __nuxt_component_2, i as __nuxt_component_9, f as __nuxt_component_0$1, w as __nuxt_component_5 } from "../server.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.module) {
    ...
    _push(`<section class="relative bg-white dark:bg-dark-800 py-12 shadow-sm dark:shadow-lg"><div class="absolute bg-white dark:bg-dark-700 p-12 rounded-3xl shadow-2xl left-1/2 -translate-x-1/2 top-4 -translate-y-2/3 flex gap-4 lg:gap-12 font-extrabold text-5xl dark:text-white text-black items-center w-fit z-10"><img class="w-20 h-20"${ssrRenderAttr("src", _imports_0)}> + `);
        ...
        if (_push2) {
          ...
          ssrRenderList(3, (i) => {
            ...
            ssrRenderList($options.tools, (tool, i2) => {
              _push2(`<div class="bg-gray-200 dark:bg-dark-700 text-gray-500 dark:text-gray-400 px-6 py-4 rounded-3xl font-semibold text-lg mr-6"${_scopeId}>${ssrInterpolate($options.getToolName(tool))}</div>`);
            });
            _push2(`<!--]--></div>`);
          });
          _push2(`<!--]--></div>`);
    ...
    _push(ssrRenderComponent(_component_ClientOnly, null, {
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mt-8"${_scopeId}><div${_scopeId}></div><!--[-->`);
          ssrRenderList(_ctx.moduleTools, (tool, index2) => {
            _push2(`<div${_scopeId}>`);
            if ($options.getModuleName(index2).toLowerCase() !== "badges") {
            ...
            vue_cjs_prod.createVNode("div", { class: "grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mt-8" }, [
              ...
              (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList(_ctx.moduleTools, (tool, index2) => {
                return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", { key: index2 }, [
                  $options.getModuleName(index2).toLowerCase() !== "badges" ? (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock(_component_NuxtLink, {
                    key: 0,
                    to: `/tools/${_ctx.$route.params.slug}/${$options.getModuleName(index2).toLowerCase()}`
                  }, {
                    default: vue_cjs_prod.withCtx(() => [
                    ...
                    _: 2
                  }, 1032, ["to"])) : vue_cjs_prod.createCommentVNode("", true)
                ]);
              }), 128))
            ])
          ];
    ...
    _push(`</div></div></section><section class="bg-gradient-to-b from-primary-400 to-primary-500 py-24 text-white mt-8"><div class="font-bold text-3xl text-center">Tu n&#39;as pas trouv\xE9 ton bonheur?</div><div class="text-xl text-center mt-4 leading-relaxed max-w-lg mx-auto">Nous acceptons toutes id\xE9es de nouvels outils, qu\u2019ils soient li\xE9s \xE0 <span class="capitalize">${ssrInterpolate(_ctx.$route.params.slug)}</span> ou pas alors n\u2019h\xE9sites pas \xE0 nous faire part de ta suggestion !</div>`);
