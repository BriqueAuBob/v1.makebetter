import { _ as __nuxt_component_0$1 } from "./Navbar.90fe011e.js";
import { v as vue_cjs_prod, _ as _export_sfc, d as __nuxt_component_0, c as __nuxt_component_1$1 } from "../server.mjs";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrRenderSlot } from "@vue/server-renderer";
import { _ as _imports_0 } from "./discord.598a3b34.js";
import AOS from "aos";
import "@heroicons/vue/outline/esm/index.js";
import "./logo.d2eabc24.js";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</li></ul></div><div class="border-2 border-primary-700 px-24 py-12"><div class="font-semibold">Nos r\xE9seaux</div><ul class="mt-4 flex gap-8 items-center text-gray-100"><li><a href="https://discord.gg/umaestro" target="_blank"><img class="w-10"${ssrRenderAttr("src", _imports_0)}></a></li><li><a href="https://twitter.com/gumaestro/" target="_blank"><img class="w-10"${ssrRenderAttr("src", _imports_1)}></a></li><li><a href="https://www.youtube.com/channel/UCCMNETJ3w46A6-E55g6GYPg" target="_blank"><img class="w-10"${ssrRenderAttr("src", _imports_2)}></a></li></ul></div><div class="border-2 border-primary-700 px-24 py-12"><div class="font-semibold">Confidentialit\xE9 et s\xE9curit\xE9</div><ul class="mt-4 flex flex-col gap-2 text-gray-100 text-sm"><li>`);
  ...
  _push(`</li><li class="text-gray-400">Politique de confidentialit\xE9</li></ul></div><div class="border-2 border-primary-700 px-24 py-8 col-span-2 flex justify-end"> umaestro.fr - 2022 </div><img class="absolute -left-64 -top-64 w-1/3"${ssrRenderAttr("src", _imports_3)}><img class="absolute -right-64 top-4 w-1/3"${ssrRenderAttr("src", _imports_3)}></footer>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(vue_cjs_prod.mergeProps({
    id: "content",
    class: "relative"
  }, _attrs))}><div class="${ssrRenderClass([!$data.banner && "opacity-0 -translate-y-24 absolute", "bg-secondary-500 text-black font-semibold text-lg text-center w-full ease-in duration-300 overflow-hidden cursor-pointer"])}"><div class="container mx-auto p-4"> Bienvenue sur notre nouveau site ! \u{1F44B}\u{1F3FC} </div></div>`);
