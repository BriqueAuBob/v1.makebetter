import { _ as _export_sfc, u as useHead, e as axios, v as vue_cjs_prod, f as __nuxt_component_0, g as __nuxt_component_4, d as __nuxt_component_1 } from "../server.mjs";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr } from "@vue/server-renderer";
import { _ as _imports_0$1 } from "./red_pink_group.82ff82e0.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div><div class="bg-primary-500 lg:col-span-3 relative"><img${ssrRenderAttr("src", _imports_0$1)} class="absolute left-1/2 -translate-x-1/2 bottom-0 w-3/4" alt="Group characters"></div></div>`);
}
