...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import("./error-404.0745fd43.js"));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import("./error-500.8dde4e00.js"));
