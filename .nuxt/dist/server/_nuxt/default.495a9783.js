import { _ as __nuxt_component_0$1 } from "./Navbar.fd0d7c97.js";
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</li><li class="text-gray-400">Politique de confidentialit\xE9</li></ul></div><div class="col-span-2 flex justify-end border-2 border-primary-700 px-24 py-8"> umaestro.fr - 2022 </div><img class="absolute -left-64 -top-64 w-1/3"${ssrRenderAttr("src", _imports_3)}><img class="absolute -right-64 top-4 w-1/3"${ssrRenderAttr("src", _imports_3)}></footer>`);
}
