import { _ as _export_sfc, u as useHead, v as vue_cjs_prod, d as __nuxt_component_1, f as __nuxt_component_0, g as __nuxt_component_4 } from "../server.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><header class="bg-primary-500 border-b-8 border-primary-400 py-48"><h1 class="font-extrabold text-5xl text-white text-center">Partenaires</h1><h2 class="text-3xl max-w-2xl text-center mx-auto mt-6 leading-relaxed text-white">D\xE9couvre nos partenaires et d\xE9couvre comment en faire partie</h2>`);
