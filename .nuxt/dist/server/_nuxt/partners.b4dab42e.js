...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><header class="bg-gradient-to-br from-primary-500 to-primary-700 border-b-8 border-primary-600 py-48"><h1 class="font-extrabold text-5xl text-white text-center">Partenaires</h1><h2 class="text-3xl max-w-2xl text-center mx-auto mt-6 leading-relaxed text-white">D\xE9couvre nos partenaires et d\xE9couvre comment en faire partie</h2>`);
