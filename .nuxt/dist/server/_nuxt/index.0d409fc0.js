...
import { a as allCards, u as useModule, t as tools } from "./Module.65a312f2.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.module) {
    ...
    if (typeof _ctx.module.icon === "string") {
      ...
      ssrRenderVNode(_push, vue_cjs_prod.createVNode(vue_cjs_prod.resolveDynamicComponent(_ctx.module.icon), { class: "h-20 w-20" }, null), _parent);
    }
    _push(`</div>`);
