import { _ as _export_sfc, h as useHead, v as vue_cjs_prod, a as axios2, d as __nuxt_component_0, c as __nuxt_component_1, l as __nuxt_component_2, m as __nuxt_component_3 } from "../server.mjs";
import { u as useAsyncData } from "./asyncData.22644d77.js";
import "destr";
import { CubeIcon } from "@heroicons/vue/outline/esm/index.js";
import { a as allCards } from "./Module.546ede74.js";
...
import { _ as _imports_0 } from "./squares.af6a1819.js";
import { _ as _imports_0$1 } from "./discord.598a3b34.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<img class="absolute -left-20 top-4"${ssrRenderAttr("src", _imports_2)}><img class="absolute -right-20 top-2"${ssrRenderAttr("src", _imports_3)}></div></div></div></header><section id="tools" class="py-32 flex flex-col justify-center container mx-auto"><div class="text-xl font-semibold text-center">Les outils que l&#39;on propose sur UMaestro</div><div class="bg-white dark:bg-dark-900 p-2 rounded-full w-fit mt-8 mx-auto flex gap-2 shadow-sm"><div class="${ssrRenderClass([_ctx.currentCategory === null && "bg-primary-500 text-white", "rounded-full px-4 py-2 text-sm font-semibold cursor-pointer flex gap-2 items-center transition ease-in duration-200"])}">Tout les outils</div><!--[-->`);
  ssrRenderList(_ctx.categories, (category, index2) => {
    _push(`<div class="${ssrRenderClass([_ctx.currentCategory === category && "bg-primary-500 text-white", "rounded-full px-4 py-2 text-sm font-semibold cursor-pointer flex gap-2 items-center dark:text-white capitalize transition ease-in duration-200"])}">${ssrInterpolate(category)}</div>`);
  });
  _push(`<!--]--></div><div class="grid lg:grid-cols-3 gap-8 mt-8 px-4 md:px-16 lg:px-24" id="__grid__cards"><!--[-->`);
  ssrRenderList(_ctx.toolsGet.filter((tool) => !_ctx.currentCategory || tool.category === _ctx.currentCategory).slice(0, 3), (tool, index2) => {
    _push(`<div>`);
    _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          ssrRenderVNode(_push2, vue_cjs_prod.createVNode(vue_cjs_prod.resolveDynamicComponent({ ..._ctx.cards[tool.tool] }), { key: index2 }, null), _parent2, _scopeId);
        } else {
          return [
  ...
  _push(`<div class="${ssrRenderClass([$setup.testimonials.length > 0 && "h-96 bg-gradient-to-t from-background dark:from-dark-950 via-background dark:via-dark-950 to-transparent bottom-0 translate-y-16 flex items-center", "absolute w-full"])}">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "rates",
    class: "mx-auto"
  }, {
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_Button, {
          ...
          default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img${ssrRenderAttr("src", _imports_4)} class="absolute -left-12 -top-12 w-32 h-32 -z-1"${_scopeId2}><img${ssrRenderAttr("src", _imports_5)} class="absolute right-0 -top-6 w-14 h-14 -z-1"${_scopeId2}><img${ssrRenderAttr("src", _imports_6)} class="absolute -right-8 -bottom-10 w-20 h-20"${_scopeId2}>`);
            } else {
              return [
                vue_cjs_prod.createVNode("img", {
                  src: _imports_4,
