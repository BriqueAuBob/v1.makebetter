import { _ as _export_sfc, u as useHead, v as vue_cjs_prod, f as __nuxt_component_0, d as __nuxt_component_1, h as __nuxt_component_2, i as __nuxt_component_9, j as __nuxt_component_4 } from "../server.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="relative hidden md:block"><img${ssrRenderAttr("src", _imports_0)} alt="3D Wave Character" class="w-full absolute -left-52 -bottom-32 scale-150 hidden xl:block">`);
  _push(ssrRenderComponent(_component_Slider, {
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div${_scopeId}><!--[-->`);
        ssrRenderList(["bg-red-500", "bg-yellow-500", "bg-secondary-600", "bg-primary-700", "bg-green-500", "bg-stone-500"].sort((a, b) => 0.5 - Math.random()), (color, index) => {
          _push2(`<div class="my-12 flex shadow-xl"${_scopeId}><aside class="${ssrRenderClass(`${color} p-8 w-1/3 rounded-l-3xl`)}"${_scopeId}><div class="bg-gray-200 rounded-full w-24 h-24 mx-auto pt-full"${_scopeId}></div><div class="bg-gray-200 rounded-sm w-full h-4 mt-4 mx-auto pt-full"${_scopeId}></div><div class="bg-gray-200 rounded-sm w-1/3 h-4 mt-2 pt-full"${_scopeId}></div></aside>`);
            ...
            default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                ...
                ssrRenderList(Math.max(2, Math.floor(Math.random() * 4)), (i) => {
                  _push3(`<div class="${ssrRenderClass(["bg-dark-600 rounded-sm h-2 mt-2 pt-full", ["w-1/3", "w-1/4", "w-full", "w-1/2", "w-3/4", "w-2/3"][Math.floor(Math.random() * 6)]])}"${_scopeId2}></div>`);
                });
                _push3(`<!--]--><!--[-->`);
                ssrRenderList(4, (i) => {
                  _push3(`<div${_scopeId2}><div class="bg-dark-700 rounded-sm w-1/3 h-4 mt-8 pt-full"${_scopeId2}></div><!--[-->`);
                  ssrRenderList(Math.max(2, Math.floor(Math.random() * 4)), (i2) => {
                    _push3(`<div class="${ssrRenderClass(["bg-dark-600 rounded-sm h-2 mt-2 pt-full", ["w-1/3", "w-1/4", "w-full", "w-1/2", "w-3/4", "w-2/3"][Math.floor(Math.random() * 6)]])}"${_scopeId2}></div>`);
                  });
                  _push3(`<!--]--></div>`);
                });
  ...
  ssrRenderList(_ctx.categories, (category, index) => {
    _push(`<div class="mb-16"><div class="font-semibold text-lg">${ssrInterpolate(category.title)}</div><div class="mt-2">${ssrInterpolate(category.subtitle)}</div><div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-6"><!--[-->`);
    ssrRenderList(category.jobs, (job, index2) => {
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Card, { class: "before:bg-white before:dark:bg-dark-800" }, {
              default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="p-8 flex flex-col justify-between h-full"${_scopeId2}><div${_scopeId2}><div class="font-semibold text-xl"${_scopeId2}>${ssrInterpolate(job.name)}</div><div class="mt-2 text-md"${_scopeId2}>${ssrInterpolate(job.description)}</div>`);
                  if (job.requirement) {
                    _push3(`<div class="mt-2 text-sm text-gray-400 italic"${_scopeId2}>${ssrInterpolate(job.requirement)}</div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><span class="flex items-center gap-2 font-medium text-blurple mt-4"${_scopeId2}>Postuler <img${ssrRenderAttr("src", _imports_1)} class="w-5 h-5" alt="Double chevron"${_scopeId2}></span></div>`);
                } else {
                  return [
