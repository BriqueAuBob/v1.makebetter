import { _ as _export_sfc, v as vue_cjs_prod, s as __nuxt_component_0, c as __nuxt_component_1, i as __nuxt_component_2, j as __nuxt_component_9, d as __nuxt_component_0$1, t as __nuxt_component_5, r as __nuxt_component_6 } from "../server.mjs";
import { CubeIcon } from "@heroicons/vue/outline/esm/index.js";
import { a as allCards, u as useModule, t as tools } from "./Module.546ede74.js";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_Empty = __nuxt_component_5;
  ...
  if (_ctx.module) {
    ...
    _push(`<section class="relative bg-white dark:bg-dark-900 py-12 shadow-sm dark:shadow-lg"><div class="absolute bg-white dark:bg-dark-800 p-12 rounded-3xl shadow-2xl left-1/2 -translate-x-1/2 top-4 -translate-y-2/3 flex gap-4 lg:gap-12 font-extrabold text-5xl dark:text-white text-black items-center w-fit z-10"><img class="w-20 h-20"${ssrRenderAttr("src", _imports_0)}> + `);
    if (typeof _ctx.module.icon === "string") {
      _push(`<img${ssrRenderAttr("src", `/icons/${_ctx.module.icon}`)} class="w-20 h-20">`);
    } else {
      ssrRenderVNode(_push, vue_cjs_prod.createVNode(vue_cjs_prod.resolveDynamicComponent(_ctx.module.icon), { class: "w-20 h-20" }, null), _parent);
    }
    _push(`</div>`);
        ...
        if (_push2) {
          ...
          ssrRenderList(3, (i) => {
            ...
            ssrRenderList($options.tools, (tool, i2) => {
              _push2(`<div class="bg-gray-200 dark:bg-dark-800 text-gray-500 dark:text-gray-400 px-6 py-4 rounded-3xl font-semibold text-lg mr-6"${_scopeId}>${ssrInterpolate($options.getToolName(tool))}</div>`);
            });
            _push2(`<!--]--></div>`);
          });
          _push2(`<!--]--></div>`);
                ...
                return vue_cjs_prod.createVNode("div", {
                  ...
                  (vue_cjs_prod.openBlock(true), vue_cjs_prod.createBlock(vue_cjs_prod.Fragment, null, vue_cjs_prod.renderList($options.tools, (tool, i2) => {
                    return vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("div", {
                      key: i2,
                      class: "bg-gray-200 dark:bg-dark-800 text-gray-500 dark:text-gray-400 px-6 py-4 rounded-3xl font-semibold text-lg mr-6"
    ...
    _push(`</section><section class="container mx-auto py-24 px-4"><div class="font-bold text-xl text-center">Nos outils</div><div class="text-lg text-center mt-4">D\xE9di\xE9s \xE0 <span class="capitalize">${ssrInterpolate(_ctx.$route.params.slug)}</span></div>`);
    _push(ssrRenderComponent(_component_ClientOnly, null, {
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mt-8" id="__grid__cards"${_scopeId}><!--[-->`);
          ssrRenderList(_ctx.moduleTools, (tool, index2) => {
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ssrRenderVNode(_push3, vue_cjs_prod.createVNode(vue_cjs_prod.resolveDynamicComponent({ ...$options.getModuleCard(index2) }), null, null), _parent3, _scopeId2);
                } else {
                  return [
          ...
          return [
            vue_cjs_prod.createVNode("div", {
              class: "grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mt-8",
              id: "__grid__cards"
            }, [
    ...
    _push(`<div class="text-lg text-center mt-12 max-w-md mx-auto">Les outils, que tu pourras retrouver ailleurs, qui te seront utiles pour <span class="capitalize">${ssrInterpolate(_ctx.$route.params.slug)}</span></div><div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mt-8"><div class="col-span-3 mt-4">`);
    _push(ssrRenderComponent(_component_Empty, { text: "Nous n'avons pas trouv\xE9 d'outils suppl\xE9mentaires..." }, null, _parent));
    _push(`</div></div></section><section class="bg-blurple py-24 text-white mt-8 container mx-auto rounded-2xl shadow-lg mb-24"><div class="font-bold text-3xl text-center">Tu n&#39;as pas trouv\xE9 ton bonheur?</div><div class="text-xl text-center mt-4 leading-relaxed max-w-lg mx-auto">Nous acceptons toutes id\xE9es de nouvels outils, qu\u2019ils soient li\xE9s \xE0 <span class="capitalize">${ssrInterpolate(_ctx.$route.params.slug)}</span> ou pas alors n\u2019h\xE9sites pas \xE0 nous faire part de ta suggestion !</div>`);
