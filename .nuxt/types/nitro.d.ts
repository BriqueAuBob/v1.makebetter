...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/message': Awaited<ReturnType<typeof import('../../server/api/message').default>>
    '/api/guilds/:id/roles': Awaited<ReturnType<typeof import('../../server/api/guilds/[id]/roles').default>>
    '/api/guilds/:id/:role': Awaited<ReturnType<typeof import('../../server/api/guilds/[id]/[role].patch').default>>
