<template>
  <div>
    ...
    <section class="container mx-auto px-4 pt-24 pb-48">
      <div class="mx-auto mb-4 text-center text-xl font-semibold">
        Article 1 – Présentation du site
      </div>
      <p class="leading-relaxed">
        Propriétaire : Draks<br />
        Webmaster : Brique au bob<br />
        Hébergeur : OVH – 2 rue Kellermann – 59100 Roubaix – France<br />
        Pour tout contact et/ou demande d’informations : contact@umaestro.fr
      </p>

      <div class="mx-auto mb-4 mt-12 text-center text-xl font-semibold">
        Article 2 – Conditions Générales d’Utilisation du Site et des Services
        Proposés
      </div>
      <p class="leading-relaxed">
        L’utilisation du site umaestro.fr implique l’acceptation pleine et
        ...
        complétées à tout moment, les utilisateurs du site Umaestro sont donc
        ...
        décidée par Draks ou Brique au bob, qui s’efforcera alors de communiquer
        préalablement aux utilisateurs les dates et heures de l’intervention.<br />
        Le site UMaestro est mis à jour régulièrement par Draks ou Brique au
        bob.
      </p>
      ...
      <p class="leading-relaxed">
        Le site UMaestro a pour objet de fournir une information concernant
        l’ensemble des activités du groupe.<br />
        Draks ou Brique au bob s’efforce de fournir sur le site UMaestro des
        ...
        Toutes les informations indiquées sur le site UMaestro sont données à
        titre indicatif et sont susceptibles d’évoluer. Par ailleurs, les
        renseignements figurant sur le site UMaestro ne sont pas exhaustifs. Ils
        sont donnés sous réserve de modifications ayant été apportées depuis
        leur mise en ligne.
      </p>

      <div class="mx-auto mb-4 mt-12 text-center text-xl font-semibold">
        Article 4 – Limitations contractuelles sur les données
      </div>
      <p class="leading-relaxed">
        Le site Internet ne pourra être tenu responsable de dommages matériels
        liés à l’utilisation. De plus, l’utilisateur du site s’engage à accéder
        au site en utilisant du matériel récent, ne contenant pas de virus et
      ...
      <p class="leading-relaxed">
        Draks est propriétaire des droits de propriété intellectuelle ou détient
        les droits d’usage sur tous les éléments accessibles sur le site,
        notamment les textes, images, graphismes, logo, icônes, sons et
        logiciels.<br />
        La consultation n’entraîne aucun transfert de droit de propriété
        intellectuelle en faveur de l’utilisateur. La reproduction, la
        rediffusion ou l’extraction automatique par tout moyen d’informations
        figurant sur le site est interdite. Draks se réserve le droit d’entamer
        toute action visant à faire cesser le préjudice. Toute reproduction,
        ...
        interdite, sauf autorisation écrite préalable de Draks.<br />
        Toute exploitation non autorisée du site ou d'un quelconque des éléments
      ...
      <p class="leading-relaxed">
        Draks ne pourra être tenue responsable des dommages directs et indirects
        causés au matériel de l’utilisateur, lors de l’accès au site UMaestro,
        ...
        Draks ne pourra également être tenue responsable des dommages indirects
        (tels par exemple qu’une perte de marché ou perte d’une chance)
        consécutifs à l’utilisation du site UMaestro. Des espaces interactifs
        (possibilité de poser des questions dans l’espace contact) sont à la
        disposition des utilisateurs. Draks se réserve le droit de supprimer,
        ...
        Draks se réserve également la possibilité de mettre en cause la
      ...
      <div class="mx-auto mb-4 mt-12 text-center text-xl font-semibold">
        Article 7 – Gestion de données personnelles
      </div>
      <p class="leading-relaxed">
        ...
        1995.<br />
        A l'occasion de l'utilisation du site UMaestro, peuvent êtres recueillis
        : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au
        site UMaestro, le fournisseur d'accès de l'utilisateur, l'adresse de
        Protocole Internet (IP) de l'utilisateur.<br />
        En tout état de cause, UMaestro ne collecte des informations
        personnelles relatives à l'utilisateur que pour le besoin de certains
        services proposés par le site UMaestro. L'utilisateur fournit ces
        ...
        site UMaestrp l’obligation ou non de fournir ces informations.<br />
        ...
        laquelle la réponse doit être envoyée.<br />
        Aucune information personnelle de l'utilisateur du site UMaestro n'est
        ...
        UMaestro et de ses droits permettrait la transmission desdites
        ...
        de l'utilisateur du site UMaestro.<br />
      ...
      <p class="leading-relaxed">
        Le site UMaestro contient un certain nombre de liens hypertextes vers
        d’autres sites, mis en place avec l’autorisation de Draks. Cependant,
        Draks n’a pas la possibilité de vérifier le contenu des sites ainsi
      ...
      <p class="leading-relaxed">
        Tout litige en relation avec l’utilisation du site UMaestro est soumis
