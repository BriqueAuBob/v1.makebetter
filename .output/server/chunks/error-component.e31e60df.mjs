...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.02e36536.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.3e89a7af.mjs'));
...
//# sourceMappingURL=error-component.e31e60df.mjs.map
