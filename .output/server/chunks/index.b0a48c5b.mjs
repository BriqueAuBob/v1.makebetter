...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><header class="relative flex flex-col items-center justify-center overflow-y-hidden bg-dark-900 pt-48 pb-32"><div class="absolute top-0 left-0 z-0 h-full w-full bg-dark-950 bg-cover bg-center opacity-75 blur-xl" style="${serverRenderer.exports.ssrRenderStyle(`background-image: url(${(_a = _ctx.user) == null ? void 0 : _a.avatar});`)}"></div><img class="z-10 w-48 rounded-full border-8 border-white"${serverRenderer.exports.ssrRenderAttr("src", (_b = _ctx.user) == null ? void 0 : _b.avatar)}><div class="z-10 mx-auto mt-4 text-center text-2xl font-semibold text-white">${serverRenderer.exports.ssrInterpolate((_c = _ctx.user) == null ? void 0 : _c.username)}</div><div class="z-10 mx-auto mt-1 text-center text-xl font-medium text-gray-400"> #${serverRenderer.exports.ssrInterpolate((_d = _ctx.user) == null ? void 0 : _d.discriminator)}</div></header><section class="container mx-auto py-32 px-4 lg:px-16 xl:px-32"><div class="mb-2 text-lg font-semibold">Mes informations</div><p class="mb-4 text-gray-500"> Ici, vous pouvez voir toutes les informations que nous sauvegardons \xE0 propos de votre profil. </p><div class="grid gap-4 italic md:grid-cols-2"><div><span class="ml-2">ID</span>`);
  ...
  _push(`<div class="mb-2 mt-12 mb-4 text-lg font-semibold">D\xE9connexion</div>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Button, {
                        ...
                        if (_push5) {
                          ...
                          return [
                            ...
                            vue_cjs_prod.createVNode("div", { class: "mt-2" }, [
                              vue_cjs_prod.createVNode("p", { class: "mt-2 text-sm text-gray-500" }, " Cette action est irreversible, il sera impossible de retrouver vos donn\xE9es apr\xE8s avoir supprimer votre compte. "),
                              vue_cjs_prod.createVNode("p", { class: "mt-4 text-sm text-gray-500" }, [
...
//# sourceMappingURL=index.b0a48c5b.mjs.map
