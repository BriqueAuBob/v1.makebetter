...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></div><div class="bg-primary-500 lg:col-span-3 relative"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} class="absolute left-1/2 -translate-x-1/2 bottom-0 w-3/4" alt="Group characters"></div></div>`);
}
...
//# sourceMappingURL=index.275e282c.mjs.map
