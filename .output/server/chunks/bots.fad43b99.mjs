import { Y, _ as _export_sfc, c as vue_cjs_prod, C as __nuxt_component_0$1, e as __nuxt_component_1$2, F as __nuxt_component_2 } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
      ...
      if (_push2) {
        ...
        _push2(serverRenderer.exports.ssrRenderComponent(_component_Button, {
          ...
          icon_left: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(serverRenderer.exports.ssrRenderComponent(_component_ChipIcon, { class: "mr-3 h-8 w-8" }, null, _parent3, _scopeId2));
            } else {
              return [
        ...
        _push2(serverRenderer.exports.ssrRenderComponent(_component_Button, {
          ...
          icon_left: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(serverRenderer.exports.ssrRenderComponent(_component_CubeIcon, { class: "mr-3 h-8 w-8" }, null, _parent3, _scopeId2));
            } else {
              return [
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_BookmarkIcon, { class: "h-6 w-6" }, null, _parent));
  _push(` Tags `);
  _push(serverRenderer.exports.ssrRenderComponent(_component_ChevronDownIcon, { class: "h-6 w-6" }, null, _parent));
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_SortDescendingIcon, { class: "h-6 w-6" }, null, _parent));
  _push(` Trier par `);
  _push(serverRenderer.exports.ssrRenderComponent(_component_ChevronDownIcon, { class: "h-6 w-6" }, null, _parent));
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_Button, {
    ...
    icon_left: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(serverRenderer.exports.ssrRenderComponent(_component_ChipIcon, { class: "mr-3 h-8 w-8" }, null, _parent2, _scopeId));
      } else {
        return [
          vue_cjs_prod.createVNode(_component_ChipIcon, { class: "mr-3 h-8 w-8" })
        ];
  ...
  _push(`</div><img class="absolute bottom-0 left-1/2 w-1/3"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)}></div></section></div>`);
}
...
//# sourceMappingURL=bots.fad43b99.mjs.map
