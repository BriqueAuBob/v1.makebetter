...
import { a as allCards } from './Module.65a312f2.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<img class="absolute -left-20 top-4"${serverRenderer.exports.ssrRenderAttr("src", _imports_2)}><img class="absolute -right-20 top-2"${serverRenderer.exports.ssrRenderAttr("src", _imports_3)}></div></div></div></header><section id="tools" class="container mx-auto flex flex-col justify-center py-32"><div class="text-center text-xl font-semibold"> Les outils que l&#39;on propose sur UMaestro </div><div class="mx-auto mt-8 flex w-fit gap-2 rounded-full bg-white p-2 shadow-sm dark:bg-dark-900"><div class="${serverRenderer.exports.ssrRenderClass([_ctx.currentCategory === null && "bg-primary-500 text-white", "flex cursor-pointer items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold transition duration-200 ease-in"])}"> Tout les outils </div><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.categories, (category, index2) => {
    _push(`<div class="${serverRenderer.exports.ssrRenderClass([_ctx.currentCategory === category && "bg-primary-500 text-white", "flex cursor-pointer items-center gap-2 rounded-full px-4 py-2 text-sm font-semibold capitalize transition duration-200 ease-in dark:text-white"])}">${serverRenderer.exports.ssrInterpolate(category)}</div>`);
  });
  _push(`<!--]--></div><div class="mt-8 grid gap-8 px-4 md:px-16 lg:grid-cols-3 lg:px-24" id="__grid__cards"><!--[-->`);
  serverRenderer.exports.ssrRenderList(_ctx.toolsGet.filter(
      ...
      if (_push2) {
        _push2(serverRenderer.exports.ssrRenderComponent(_component_Button, {
          ...
          default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_4)} class="absolute -left-12 -top-12 -z-1 h-32 w-32"${_scopeId2}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_5)} class="absolute right-0 -top-6 -z-1 h-14 w-14"${_scopeId2}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_6)} class="absolute -right-8 -bottom-10 h-20 w-20"${_scopeId2}>`);
            } else {
              return [
                vue_cjs_prod.createVNode("img", {
                  src: _imports_4,
...
//# sourceMappingURL=index.e9cd3974.mjs.map
