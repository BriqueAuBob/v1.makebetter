import { _ as _export_sfc, j as useHead, c as client, d as __nuxt_component_1$3, b as __nuxt_component_4$2, e as __nuxt_component_0$5 } from './server.mjs';
...
const _sfc_main = {
  ...
  methods: {
    async login() {
      const { data } = await client.get("/auth/oauth2/discord");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid min-h-screen md:grid-cols-4 lg:grid-cols-5" }, _attrs))}><div class="container col-span-3 mx-auto flex max-w-xl flex-col items-center justify-center gap-8 px-4 py-48 md:col-span-3 lg:col-span-2 lg:px-16"><div class="w-full"><h1 class="text-xl font-semibold">Authentification</h1><h2 class="text-md mt-1 font-medium"> Tu peux te connecter via diff\xE9rentes m\xE9thodes ! </h2></div><div class="flex w-full flex-col gap-4">`);
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode("Je n'ai pas encore de compte")
        ];
      }
    }),
    _: 1
...
//# sourceMappingURL=index.3d8a68b7.mjs.map
