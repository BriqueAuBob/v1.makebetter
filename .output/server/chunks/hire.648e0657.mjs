...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
            ...
            default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                ...
                serverRenderer.exports.ssrRenderList(4, (i) => {
                  ...
                  serverRenderer.exports.ssrRenderList(Math.max(
                    2,
  ...
  serverRenderer.exports.ssrRenderList(_ctx.categories, (category, index) => {
    _push(`<div class="mb-16"><div class="text-lg font-semibold">${serverRenderer.exports.ssrInterpolate(category.title)}</div><div class="mt-2">${serverRenderer.exports.ssrInterpolate(category.subtitle)}</div><div class="mt-6 grid gap-8 md:grid-cols-2 lg:grid-cols-3"><!--[-->`);
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(serverRenderer.exports.ssrRenderComponent(_component_Card, null, {
              default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex h-full flex-col justify-between p-8"${_scopeId2}><div${_scopeId2}><div class="text-xl font-semibold"${_scopeId2}>${serverRenderer.exports.ssrInterpolate(job.name)}</div><div class="text-md mt-2"${_scopeId2}>${serverRenderer.exports.ssrInterpolate(job.description)}</div>`);
                  if (job.requirement) {
                    _push3(`<div class="mt-2 text-sm italic text-gray-400"${_scopeId2}>${serverRenderer.exports.ssrInterpolate(job.requirement)}</div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div><span class="mt-4 flex items-center gap-2 font-medium text-primary-500"${_scopeId2}>Postuler <img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} class="h-5 w-5" alt="Double chevron"${_scopeId2}></span></div>`);
                } else {
                  return [
...
//# sourceMappingURL=hire.648e0657.mjs.map
