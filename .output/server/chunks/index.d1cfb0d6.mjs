import { _ as _export_sfc, u as useHead, e as axios, v as vue_cjs_prod, f as __nuxt_component_0$6, d as __nuxt_component_1$1, k as __nuxt_component_2$1, l as __nuxt_component_3$3, m as __nuxt_component_4$1, n as __nuxt_component_3$2 } from './server.mjs';
import { u as useAsyncData } from './asyncData.be0d0492.mjs';
import { CubeIcon, EyeIcon, CodeIcon, PencilIcon } from '@heroicons/vue/outline/esm/index.js';
import { _ as _imports_0 } from './red_pink_group.82ff82e0.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_FeaturesList = __nuxt_component_3$3;
  const _component_ToolsCategoryCard = __nuxt_component_4$1;
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { href: "#tools" }, {
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_FeaturesList, { class: "mt-8" }, null, _parent));
  _push(`</div><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} alt="Objects 3D" class="w-2/3 mx-auto mt-8 lg:mt-0"></section><section class="container mx-auto px-4 py-16" id="tools"><div class="font-semibold text-2xl leading-relaxed max-w-sm text-center mx-auto">On propose d\xE9j\xE0 des outils dans ces cat\xE9gories</div><div class="flex flex-wrap justify-center gap-6 mt-8 max-w-5xl mx-auto"><!--[-->`);
  serverRenderer.exports.ssrRenderList($options.activeCategories, (category, index2) => {
    _push(serverRenderer.exports.ssrRenderComponent(_component_ToolsCategoryCard, {
      key: index2,
      category
    }, null, _parent));
  });
  ...
  serverRenderer.exports.ssrRenderList($options.disabledCategories, (category, index2) => {
    _push(serverRenderer.exports.ssrRenderComponent(_component_ToolsCategoryCard, {
      key: index2,
      category
    }, null, _parent));
  ...
  _push(`</div><img${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} class="mx-auto lg:w-2/3" alt="Tchating 3D character web developer"></div></div><div class="absolute top-0 flex overflow-x-hidden fill-background dark:fill-dark-900"><!--[-->`);
  serverRenderer.exports.ssrRenderList(7, (i) => {
      ...
      if (_push2) {
        _push2(serverRenderer.exports.ssrRenderComponent(_component_Button, {
          ...
          default: vue_cjs_prod.withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_3)} class="absolute -left-12 -top-12 w-32 h-32 -z-1"${_scopeId2}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_4)} class="absolute right-0 -top-6 w-14 h-14 -z-1"${_scopeId2}><img${serverRenderer.exports.ssrRenderAttr("src", _imports_5)} class="absolute -right-8 -bottom-10 w-20 h-20"${_scopeId2}>`);
            } else {
              return [
...
//# sourceMappingURL=index.d1cfb0d6.mjs.map
