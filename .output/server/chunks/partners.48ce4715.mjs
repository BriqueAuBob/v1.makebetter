import { _ as _export_sfc, k as useHead, c as vue_cjs_prod, e as __nuxt_component_1$2, g as __nuxt_component_0$5, d as __nuxt_component_4$2 } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><header class="bg-gradient-to-br from-primary-500 to-primary-700 border-b-8 border-primary-600 py-48"><h1 class="font-extrabold text-5xl text-white text-center">Partenaires</h1><h2 class="text-3xl max-w-2xl text-center mx-auto mt-6 leading-relaxed text-white">D\xE9couvre nos partenaires et d\xE9couvre comment en faire partie</h2>`);
  ...
  _push(`<!--]--></div></section><section class="bg-primary-500 pb-48 mt-24 pt-96 relative px-2 text-white container mx-auto mb-24 rounded-2xl shadow-md"><div class="container mx-auto max-w-xl"><h4 class="mx-auto text-center font-semibold text-3xl mb-16">Devenir partenaire</h4>`);
...
//# sourceMappingURL=partners.48ce4715.mjs.map
