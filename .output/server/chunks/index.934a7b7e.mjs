import { _ as _export_sfc, c as vue_cjs_prod, i as __nuxt_component_0$3, j as __nuxt_component_1$1, e as __nuxt_component_1$2 } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_ArticlesThumbnailsBig = __nuxt_component_0$3;
  const _component_ArticlesThumbnailsSmall = __nuxt_component_1$1;
  const _component_Button = __nuxt_component_1$2;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><header class="border-b-8 border-primary-400 bg-primary-500 py-48"><h1 class="text-center text-5xl font-extrabold text-white"> Nos articles </h1><h2 class="mx-auto mt-6 max-w-2xl text-center text-3xl leading-relaxed text-white"> On \xE9crit r\xE9guli\xE8rement des articles pour mettre notre communaut\xE9 au courant de certaines choses </h2><div class="container mx-auto mt-12 mb-52 px-4 pb-96 lg:mb-0 lg:pb-32"><div class="relative"><div class="absolute grid w-full gap-8 lg:grid-cols-2">`);
...
//# sourceMappingURL=index.934a7b7e.mjs.map
