import { Y, _ as _export_sfc, D as __nuxt_component_0$1, d as __nuxt_component_1$3, G as __nuxt_component_2 } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_ChipIcon = resolveComponent("ChipIcon");
  const _component_CubeIcon = resolveComponent("CubeIcon");
  const _component_BookmarkIcon = resolveComponent("BookmarkIcon");
  ...
  _push(ssrRenderComponent(_component_ToolsHeader, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_Button, {
          ...
          icon_left: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              return [
                createVNode(_component_ChipIcon, { class: "mr-3 h-8 w-8" })
              ];
            }
          }),
          _: 1
        ...
        return [
          createVNode("h1", { class: "mx-auto max-w-lg text-4xl font-extrabold" }, " Liste de robots Discord "),
          createVNode("h2", { class: "mx-auto mt-4 max-w-lg text-2xl leading-relaxed" }, " Pr\xE9sente ton robot ou trouve le robot qu'il te faut pour ton serveur Discord "),
          createVNode("div", { class: "mt-12 flex justify-center gap-4" }, [
...
//# sourceMappingURL=bots.248cd023.mjs.map
