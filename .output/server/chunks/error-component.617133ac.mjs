...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404.3671e758.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500.44125a33.mjs'));
...
//# sourceMappingURL=error-component.617133ac.mjs.map
