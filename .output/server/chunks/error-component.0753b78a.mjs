import { c as vue_cjs_prod } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.44e7276a.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.049628ad.mjs'));
...
//# sourceMappingURL=error-component.0753b78a.mjs.map
