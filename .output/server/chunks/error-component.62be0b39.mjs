...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.cb53ff17.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.3a0b1a70.mjs'));
...
//# sourceMappingURL=error-component.62be0b39.mjs.map
