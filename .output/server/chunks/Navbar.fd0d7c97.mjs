...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<nav${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "absolute top-0 z-10 w-full" }, _attrs))} data-v-d262ae63><div class="container mx-auto flex items-center justify-between py-6 px-4 text-white" data-v-d262ae63><div class="flex grow basis-0" data-v-d262ae63>`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
    ...
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img class="h-10"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} data-v-d262ae63${_scopeId}> umaestro.fr `);
      } else {
        return [
  ...
  serverRenderer.exports.ssrRenderList(_ctx.navigation, (link, index) => {
    _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<li class="duration-300 ease-in hover:text-white" data-v-d262ae63${_scopeId}>${serverRenderer.exports.ssrInterpolate(link.name)}</li>`);
        } else {
          return [
  ...
  _push(`<!--]--></ul><div class="hidden grow basis-0 items-center justify-end gap-6 lg:flex" data-v-d262ae63><span class="cursor-pointer"${serverRenderer.exports.ssrRenderAttr("small", true)} data-v-d262ae63>`);
  if (_ctx.$colorMode.value === "light") {
    _push(serverRenderer.exports.ssrRenderComponent(_component_MoonIcon, { class: "h-8 w-8" }, null, _parent));
  } else {
    _push(serverRenderer.exports.ssrRenderComponent(_component_SunIcon, { class: "h-8 w-8" }, null, _parent));
  }
  _push(`</span>`);
  if (!_ctx.authenticated) {
    ...
    _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        var _a, _b, _c, _d;
        if (_push2) {
          _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", (_a = _ctx.user) == null ? void 0 : _a.avatar)} class="h-6 w-6 rounded-full" data-v-d262ae63${_scopeId}> ${serverRenderer.exports.ssrInterpolate((_b = _ctx.user) == null ? void 0 : _b.username)}`);
        } else {
          return [
            vue_cjs_prod.createVNode("img", {
  ...
  _push(`</div><button class="px-4 py-2 lg:hidden" data-v-d262ae63><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} class="h-8 w-8" data-v-d262ae63></button><div class="${serverRenderer.exports.ssrRenderClass([
  ...
  if (!_ctx.authenticated) {
    ...
    _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        var _a, _b, _c, _d;
        if (_push2) {
          _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", (_a = _ctx.user) == null ? void 0 : _a.avatar)} class="h-8 w-8 rounded-full" data-v-d262ae63${_scopeId}> ${serverRenderer.exports.ssrInterpolate((_b = _ctx.user) == null ? void 0 : _b.username)}`);
        } else {
          return [
            vue_cjs_prod.createVNode("img", {
              src: (_c = _ctx.user) == null ? void 0 : _c.avatar,
  ...
  serverRenderer.exports.ssrRenderList(_ctx.navigation, (link, index) => {
    _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
      ...
      default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<li class="py-4 text-xl font-medium duration-300 ease-in hover:text-gray-900 dark:hover:text-dark-100" data-v-d262ae63${_scopeId}>${serverRenderer.exports.ssrInterpolate(link.name)}</li>`);
        } else {
          return [
...
//# sourceMappingURL=Navbar.fd0d7c97.mjs.map
