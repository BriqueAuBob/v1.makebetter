...
import { a as allCards, u as useModule, t as tools } from './Module.41fa754e.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.module) {
    ...
    _push(`<section class="relative bg-white dark:bg-dark-900 py-12 shadow-sm dark:shadow-lg"><div class="absolute bg-white dark:bg-dark-800 p-12 rounded-3xl shadow-2xl left-1/2 -translate-x-1/2 top-4 -translate-y-2/3 flex gap-4 lg:gap-12 font-extrabold text-5xl dark:text-white text-black items-center w-fit z-10"><img class="w-20 h-20"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)}> + `);
        ...
        if (_push2) {
          ...
          serverRenderer.exports.ssrRenderList(3, (i) => {
            ...
            serverRenderer.exports.ssrRenderList($options.tools, (tool, i2) => {
              _push2(`<div class="bg-gray-200 dark:bg-dark-800 text-gray-500 dark:text-gray-400 px-6 py-4 rounded-3xl font-semibold text-lg mr-6"${_scopeId}>${serverRenderer.exports.ssrInterpolate($options.getToolName(tool))}</div>`);
            });
            _push2(`<!--]--></div>`);
          });
          _push2(`<!--]--></div>`);
    ...
    _push(`</div></div></section><section class="bg-blurple py-24 text-white mt-8 container mx-auto rounded-2xl shadow-lg mb-24"><div class="font-bold text-3xl text-center">Tu n&#39;as pas trouv\xE9 ton bonheur?</div><div class="text-xl text-center mt-4 leading-relaxed max-w-lg mx-auto">Nous acceptons toutes id\xE9es de nouvels outils, qu\u2019ils soient li\xE9s \xE0 <span class="capitalize">${serverRenderer.exports.ssrInterpolate(_ctx.$route.params.slug)}</span> ou pas alors n\u2019h\xE9sites pas \xE0 nous faire part de ta suggestion !</div>`);
...
//# sourceMappingURL=index.62ca821f.mjs.map
