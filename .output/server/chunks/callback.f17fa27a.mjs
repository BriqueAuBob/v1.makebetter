import { _ as _export_sfc, b as axios2, c as vue_cjs_prod } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex h-screen items-center justify-center bg-primary-500 text-center text-3xl font-bold text-white" }, _attrs))}> Chargement en cours... </div>`);
}
...
//# sourceMappingURL=callback.f17fa27a.mjs.map
