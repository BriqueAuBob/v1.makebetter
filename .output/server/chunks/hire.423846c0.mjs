import { _ as _export_sfc, j as useHead, e as __nuxt_component_0$5, d as __nuxt_component_1$3, k as __nuxt_component_2$2, l as __nuxt_component_9, q as __nuxt_component_4$1 } from './server.mjs';
import { withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, createTextVNode, useSSRContext } from 'vue';
      ...
      if (_push2) {
          ...
          _push2(ssrRenderComponent(_component_ClientOnly, null, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                ...
                return [
                  createVNode("main", { class: "w-2/3 rounded-r-3xl bg-white py-8 pl-4 pr-8" }, [
                    createVNode("div", { class: "pt-full mx-auto mt-4 h-4 w-full rounded-sm bg-dark-800" }),
                    createVNode("div", { class: "pt-full mt-2 mb-2 h-4 w-1/3 rounded-sm bg-dark-700" }),
                    (openBlock(true), createBlock(Fragment, null, renderList(Math.max(2, Math.floor(Math.random() * 4)), (i) => {
                    ...
                    (openBlock(), createBlock(Fragment, null, renderList(4, (i) => {
                      return createVNode("div", { key: i }, [
                        createVNode("div", { class: "pt-full mt-8 h-4 w-1/3 rounded-sm bg-dark-700" }),
                        (openBlock(true), createBlock(Fragment, null, renderList(Math.max(
                          2,
                          Math.floor(Math.random() * 4)
                        ), (i2) => {
                          return openBlock(), createBlock("div", {
        ...
        return [
          createVNode("div", null, [
            (openBlock(true), createBlock(Fragment, null, renderList(_ctx.colors.sort(
              (a, b) => 0.5 - Math.random()
            ), (color, index) => {
              return openBlock(), createBlock("div", {
                key: index,
                ...
                createVNode("aside", {
                  ...
                  createVNode("div", { class: "pt-full mx-auto h-24 w-24 rounded-full bg-gray-200" }),
                  createVNode("div", { class: "pt-full mx-auto mt-4 h-4 w-full rounded-sm bg-gray-200" }),
                  createVNode("div", { class: "pt-full mt-2 h-4 w-1/3 rounded-sm bg-gray-200" })
                ], 2),
            ...
            _push2(ssrRenderComponent(_component_Card, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createVNode("div", { class: "flex h-full flex-col justify-between p-8" }, [
                      createVNode("div", null, [
                        createVNode("div", { class: "text-xl font-semibold" }, toDisplayString(job.name), 1),
                        createVNode("div", { class: "text-md mt-2" }, toDisplayString(job.description), 1),
                        job.requirement ? (openBlock(), createBlock("div", {
                          key: 0,
                          class: "mt-2 text-sm italic text-gray-400"
                        }, toDisplayString(job.requirement), 1)) : createCommentVNode("", true)
                      ]),
                      createVNode("span", { class: "mt-4 flex items-center gap-2 font-medium text-primary-500" }, [
                        createTextVNode("Postuler "),
                        createVNode("img", {
                          src: _imports_0,
                          class: "h-5 w-5",
                          alt: "Double chevron"
...
//# sourceMappingURL=hire.423846c0.mjs.map
