...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</li></ul></div><div class="border-2 border-primary-700 px-24 py-12"><div class="font-semibold">Nos r\xE9seaux</div><ul class="mt-4 flex items-center gap-8 text-gray-100"><li><a href="https://discord.gg/umaestro" target="_blank"><img class="w-10"${serverRenderer.exports.ssrRenderAttr("src", _imports_0)}></a></li><li><a href="https://twitter.com/gumaestro/" target="_blank"><img class="w-10"${serverRenderer.exports.ssrRenderAttr("src", _imports_1)}></a></li><li><a href="https://www.youtube.com/channel/UCCMNETJ3w46A6-E55g6GYPg" target="_blank"><img class="w-10"${serverRenderer.exports.ssrRenderAttr("src", _imports_2)}></a></li></ul></div><div class="border-2 border-primary-700 px-24 py-12"><div class="font-semibold">Confidentialit\xE9 et s\xE9curit\xE9</div><ul class="mt-4 flex flex-col gap-2 text-sm text-gray-100"><li>`);
  ...
  _push(`</li><li class="text-gray-400">Politique de confidentialit\xE9</li></ul></div><div class="col-span-2 flex justify-end border-2 border-primary-700 px-24 py-8"> umaestro.fr - 2022 </div><img class="absolute -left-64 -top-64 w-1/3"${serverRenderer.exports.ssrRenderAttr("src", _imports_3)}><img class="absolute -right-64 top-4 w-1/3"${serverRenderer.exports.ssrRenderAttr("src", _imports_3)}></footer>`);
}
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
    id: "content",
    class: "relative"
  }, _attrs))}><div class="${serverRenderer.exports.ssrRenderClass([!$data.banner && "absolute -translate-y-24 opacity-0", "w-full cursor-pointer overflow-hidden bg-secondary-500 text-center text-lg font-semibold text-black duration-300 ease-in"])}"><div class="container mx-auto p-4"> Bienvenue sur notre nouveau site ! \u{1F44B}\u{1F3FC} </div></div>`);
...
//# sourceMappingURL=default.495a9783.mjs.map
