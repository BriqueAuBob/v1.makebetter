...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.1efff7e2.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.fa516a71.mjs'));
...
//# sourceMappingURL=error-component.df55d43d.mjs.map
