...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.ebde539e.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.d054cf21.mjs'));
...
//# sourceMappingURL=error-component.20ed56f4.mjs.map
