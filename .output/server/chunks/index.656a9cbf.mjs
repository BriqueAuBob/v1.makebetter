import { _ as _export_sfc, k as useHead, b as axios2, c as vue_cjs_prod, e as __nuxt_component_1$2, d as __nuxt_component_4$2, g as __nuxt_component_0$5 } from './server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "grid min-h-screen md:grid-cols-4 lg:grid-cols-5" }, _attrs))}><div class="container col-span-3 mx-auto flex max-w-xl flex-col items-center justify-center gap-8 px-4 py-48 md:col-span-3 lg:col-span-2 lg:px-16"><div class="w-full"><h1 class="text-xl font-semibold">Authentification</h1><h2 class="text-md mt-1 font-medium"> Tu peux te connecter via diff\xE9rentes m\xE9thodes ! </h2></div><div class="flex w-full flex-col gap-4">`);
  _push(serverRenderer.exports.ssrRenderComponent(_component_Button, {
    ...
    icon_left: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} alt="Discord" class="mr-4 h-6 w-6"${_scopeId}>`);
      } else {
        return [
  ...
  _push(`</div></div></div><div class="relative bg-primary-500 lg:col-span-3"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} class="absolute left-1/2 bottom-0 w-3/4 -translate-x-1/2" alt="Group characters"></div></div>`);
}
...
//# sourceMappingURL=index.656a9cbf.mjs.map
