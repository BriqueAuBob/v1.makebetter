...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.167cf6f2.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.37d3d7b2.mjs'));
...
//# sourceMappingURL=error-component.48252838.mjs.map
