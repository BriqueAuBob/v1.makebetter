...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.e41be00f.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.0e7bf4b3.mjs'));
...
//# sourceMappingURL=error-component.b71b3b2e.mjs.map
