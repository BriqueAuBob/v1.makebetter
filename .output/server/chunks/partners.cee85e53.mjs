...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><header class="border-b-8 border-primary-600 bg-gradient-to-br from-primary-500 to-primary-700 py-48"><h1 class="text-center text-5xl font-extrabold text-white"> Partenaires </h1><h2 class="mx-auto mt-6 max-w-2xl text-center text-3xl leading-relaxed text-white"> D\xE9couvre nos partenaires et d\xE9couvre comment en faire partie </h2>`);
...
//# sourceMappingURL=partners.cee85e53.mjs.map
